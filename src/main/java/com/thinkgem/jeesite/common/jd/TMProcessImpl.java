...
public class TMProcessImpl implements Processable {
    @Override
    public void process(Page page) {
        ...
        try {
            String goodName = HtmlUtils.getText(rootNode, "//h1[@data-spm='1000983']");
            page.setGoodName(goodName);

            List picUrl = HtmlUtils.getListAttributeByName(rootNode, "//div[@class='tb-thumb-content']/ul/li/img","src","");
