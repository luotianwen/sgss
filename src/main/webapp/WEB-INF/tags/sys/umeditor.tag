...
<script type="text/javascript">include('ueditor_lib','${ctxStatic}/ueditor/',['themes/default/css/umeditor.css', 'umeditor.config.js','umeditor.min.js','lang/zh-cn/zh-cn.js']);</script>
