...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/tuan/dlTuanOrder/">团购订单列表</a></li>
		<li class="active"><a href="${ctx}/tuan/dlTuanOrder/form?id=${dlTuanOrder.id}">团购订单<shiro:hasPermission name="tuan:dlTuanOrder:edit">${not empty dlTuanOrder.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="tuan:dlTuanOrder:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="dlTuanOrder" action="${ctx}/tuan/dlTuanOrder/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="ordernumber" htmlEscape="false" maxlength="10" class="input-xlarge required"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="tuan:dlTuanOrder:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
