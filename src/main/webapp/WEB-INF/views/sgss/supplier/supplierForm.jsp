...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/supplier/supplier/">供应商管理列表</a></li>
		<li class="active"><a href="${ctx}/supplier/supplier/form?id=${supplier.id}">供应商管理<shiro:hasPermission name="supplier:supplier:edit">${not empty supplier.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="supplier:supplier:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="supplier" action="${ctx}/supplier/supplier/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">联系电话:（密码为手机后6位）</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="loginName" htmlEscape="false" maxlength="12" class="input-xlarge "/>
			</div>
		</div>
		<%--<div class="control-group">
