...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/order/supplierorder/afterlist">总售后管理列表</a></li>
	</ul>
				...
				<td>
				 ...
				 <td>
					 <c:if test="${empty simpleOrderAfter.backaddress}">
						 <a href="${ctx}/order/supplierorder/backaddress?id=${simpleOrderAfter.id}&orderid=${simpleOrderAfter.orderid}&backaddress="
					 ...
					 <c:if test="${simpleOrderAfter.type==2 &&  empty simpleOrderAfter.backcourier &&not empty simpleOrderAfter.backaddress}">
						 <a href="${ctx}/order/supplierorder/backcourier?id=${simpleOrderAfter.id}&orderid=${simpleOrderAfter.orderid}"
